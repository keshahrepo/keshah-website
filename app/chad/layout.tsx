...
// Mirrors /start/layout.tsx — same asset preloads so the funnel experience
// is identical. Paths resolve to /start/results/* and /start/video/* because
// the actual files live under public/start.
const PREFETCH_GIFS = [
...
export default function ChadLayout({ children }: { children: React.ReactNode }) {
  return (
    <>
      <link
        rel="preload"
