...
interface Props {
  ...
  height?: number;
  /** Show the label pair at the bottom. Default true. */
  showLabels?: boolean;
  /** Left/right label pair. Defaults to "Tight" / "Healthy" — the /trial
   *  page passes "Now" / "After" to frame this as a temporal before/after. */
...
export default function BloodVesselAnimation({
  ...
  height = 200,
  showLabels = true,
  labels = { left: "Tight", right: "Healthy" },
  className,
}: Props) {
