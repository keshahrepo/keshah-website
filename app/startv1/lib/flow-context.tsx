...
// /startv1 = preserved 30-step paywall funnel (moved here when the new
// text-consult funnel took over /start). Own localStorage key so users
// resuming mid-funnel don't get their state hijacked between /start and
// /startv1 or vice versa.
const DEFAULT_STORAGE_KEY = "keshah_startv1_state_v1";
  ...
  useEffect(() => {
    ...
    try {
      ...
      const source = (() => {
        ...
        if (p.startsWith("/startv1")) return "us_v1_paywall";
        return "us";
      })();
