...
//   4. watchTrialInfo     — 7-day trial explainer + RC checkout (terminal)
//
// Uses FlowProvider so ResultScreenshotsStep + TrialInfoPage7Day can share
// updateAnswers/next just like inside /start. Each of the primary pages
// advances via next(); watchTrialInfo is the terminal — checkout hands off
// to RC / native app via redirect, so no purchaseSuccess screen lives here.

import { FlowProvider, useFlow } from "../../start/lib/flow-context";
import type { StartStep } from "../../start/lib/types";
import ResultScreenshotsStep from "../../start/steps/ResultScreenshotsStep";
import SocialProofStep from "../../start/steps/SocialProofStep";
